...
int main() {
  ...
  printf("The bit in position %d of number 45 is :%d\n" ,Position,((Number & TheOne))>>Position);// A complication is that computers translate machine language to human form  .
